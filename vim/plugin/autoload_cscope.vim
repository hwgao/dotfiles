...
function s:Cycle_macros_menus()
  ...
  if cscope_connection()
    ...
    silent! map <unique> <C-\>t :cs find t <C-R>=expand("<cword>")<CR>
    silent! map <unique> <C-\>e :cs find e <C-R>=expand("<cword>")<CR>
    ...
    if has("menu")
      ...
      nmenu &Cscope.Find.String<Tab><c-\\>t
      ...
      nmenu &Cscope.Find.Assignment<Tab><c-\\>i
